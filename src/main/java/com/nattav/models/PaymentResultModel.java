...
public class PaymentResultModel {
	...
	public String toString() {
		return "PaymentResultModel [res_cd=" + res_cd + ", res_msg=" + res_msg + ", tno=" + tno + ", trade_mony="
				+ trade_mony + ", trade_hms=" + trade_hms + ", card_no=" + card_no + ", auth_no=" + auth_no
				+ ", auth_ymd=" + auth_ymd + ", auth_hms=" + auth_hms + ", trade_ymd=" + trade_ymd + " ]";
	}
